Report_demo_13272_nodb <- function(datasets)
{
    ...
    #################### merge files
    merged = Reduce(function(x, y) merge(x, y), list(tcelladmin_unique,demo_select,onstudy_arm))
    ...
    split_by_treatment = split(merged_nodupl,merged_nodupl$txarm)

Report_death_14036_nodb <-function(datasets)
{
    #Data cleanup
    ...
    #rename columns
    merged_clean2 = rename(merged_clean2, "Date of Death"="DEATHDATE_FORMAT", "Last protocol Treatment Date"="LASTPROTTXDATE_FORMAT","Days Between Last Treatment Date and Death Date"=diff,"Cause of Death"="deathcause")

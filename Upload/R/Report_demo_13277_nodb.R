Report_demo_13277_nodb <- function(datasets)
{
    ...
    merged_nodupl = mutate(merged_nodupl, ETHNICITY_RECODE = ifelse(ethnicity %in% "Hispanic or Latino", "Hispanic",ifelse(ethnicity %in% "Non-Hispanic or Latino", "Non-Hispanic", ifelse(ethnicity %in% "Unknown","Unknown or Not Reported","NONE"))))

Report_death_13351_nodb <-function(datasets)
{
    #Data cleanup
    #select the desired columns 
    fu_death = datasets$fu.CSV %>% rename_all(tolower)  %>% rename_all(tolower) %>% dplyr::select(subject,deathdate_raw,vitalstatus,deathcause)
